      ...
      settings =
        let
          averageColor = color1: color2: (
            let
              color1Rgba = inputs.nix-rice.lib.nix-rice.color.hexToRgba color1;
              color2Rgba = inputs.nix-rice.lib.nix-rice.color.hexToRgba color2;
            in
            inputs.nix-rice.lib.nix-rice.color.toRgbHex {
